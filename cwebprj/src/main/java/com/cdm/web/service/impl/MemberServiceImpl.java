...
public class MemberServiceImpl implements MemberService {
	...
	@Override
	public void keepLogin(String member_id, String sessionId, Date sessionLimit) throws Exception {	//세션 리밋 설정
		memberDAO.keepLogin(member_id, sessionId, sessionLimit);
	}
