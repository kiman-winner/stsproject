...
public interface NoticeDAO {
	...
	Map<String, Object> selectFileInfo(String fileNo) throws Exception; // 공지사항 파일 다운

	List<NoticeDTO> listSearch() throws Exception; // 홈페이지 공지사항

	String searchDeleteFile(String FILE_NO) throws Exception; // 공지사항 파일 검색

	void deleteFile(String FILE_NO) throws Exception; // 공지사항 파일 삭제
