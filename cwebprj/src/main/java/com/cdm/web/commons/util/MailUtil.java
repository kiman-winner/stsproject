...
public class MailUtil {//메일관리
	public static void sendMail(String email, String id, String pw) throws Exception { // 비밀번호 초기화 메일 발송

		// Mail Server 설정
		String charSet = "utf-8";
		String hostSMTP = "smtp.naver.com"; // SMTP 서버명
		String hostSMTPid = "prometheus0"; // 아이디
		String hostSMTPpwd = "ehdals96!@"; // 비밀번호
		// 보내는 사람
