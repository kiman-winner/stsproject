...
<%@include file="/WEB-INF/view/include/header.jsp"%>
	...
	<div id="body">
		<div class="content-container clearfix">
			...
			<main>
		<h2 class="main title">회원 비밀번호 리셋</h2>
	
		<form method="post" action="pwd-reset.do">
		<div class="margin-top first color-orange text-align-center">
			※가입할 때 등록한 이메일 주소로 임시 비밀번호가 전달됩니다.
		</div>
				...
				<table class="table border-top-none" style="margin-bottom:20px;">
					...
					<tr class="email ">
						...
						<td colspan="3" class="text-align-left indent">
							...
							<span class="color-orange">※임시 비밀번호가 메일로 전송됩니다.</span>							
						</td>
					</tr>
		...
		<div class="margin-top text-align-center">
			<input class="btn-text btn-default" type="submit" value="비밀번호 리셋" />			
		</div>
		</form>
	</main>
